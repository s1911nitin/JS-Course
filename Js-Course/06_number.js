...
// let myNumber = new Number(5468);

// console.log(myNumber, typeof myNumber);
// console.log(myNumber.toFixed(2), typeof myNumber.toFixed(2));
// console.log(myNumber.toPrecision(3), typeof myNumber.toPrecision(3));
